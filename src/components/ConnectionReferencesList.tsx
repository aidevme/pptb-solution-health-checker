...
const useStyles = makeStyles({
  ...
  /** Connector display name column â€” AUDIT-006: full overflow protection required */
  connectorColumn: {
              ...
              <div className={shared.expandedDetails}>
                <div className={shared.detailsGrid}>
                  ...
                  <div className={shared.detailItem}>
                    ...
                    <Text className={shared.detailValue}>{ref.connectorDisplayName || 'â€”'}</Text>
                  </div>
                  <div className={shared.detailItem}>
