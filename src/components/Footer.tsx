...
export function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      <Text className={styles.text}>Power Platform Solution Health Checker (PPSB) v{packageJson.version}</Text>
      <Text className={styles.text}>•</Text>
      <Text className={styles.text}>
        by{' '}
        <Link
          onClick={(e) => { e.preventDefault(); openExternal('https://github.com/aidevme'); }}
          href="https://github.com/aidevme"
