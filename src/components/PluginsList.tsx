...
// 'Asynchronous' is NOT a stage â€” it is a mode. Asynchronous plugins use stage 50 (PostOperation).
const STAGE_VALUES = ['PreValidation', 'PreOperation', 'PostOperation'];
const MODE_VALUES = ['Synchronous', 'Asynchronous'];
const PLUGIN_TYPE_DROPDOWN_MIN_WIDTH = '130px'; // fixed dropdown width â€” no token equivalent
const STATE_VALUES = ['Enabled', 'Disabled'];

/**
 * Display-label map for filter buttons: maps canonical stage name â†’ hyphenated UI label.
...
const useStyles = makeStyles({
  ...
  typeDropdown: {
    minWidth: PLUGIN_TYPE_DROPDOWN_MIN_WIDTH, // fixed dropdown width â€” no token equivalent
  },
});
